    ...
    <>
      ...
      <div className='p-6 flex flex-row gap-5'>
        ...
        <div className='basis-2/3 p-4'>
          ...
          <div className='shadow-lg p-4 bg-indigo-50 rounded-lg my-6'>
        ...
        <div className='basis-1/3 shadow-lg p-4 bg-indigo-100 rounded-lg my-4'>
          ...
          <div className='shadow-lg rounded-md p-4 my-6 bg-white'>
